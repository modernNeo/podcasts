...
from podcasts.models import YouTubePodcast, RSS_FEED_FOLDER_NAME, ARCHIVE_FOLDER_NAME, VideoWithNewDateFormat, \
    WarnStreamHandlerRecord, TroubleRecord
...
def pull_latest_youtube_videos():
    ...
    WarnStreamHandlerRecord.objects.all().delete()
    TroubleRecord.objects.all().delete()
